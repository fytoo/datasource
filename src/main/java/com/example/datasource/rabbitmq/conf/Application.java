 ...
 */
package com.example.datasource.rabbitmq.conf;
...
public class Application {
    ...
    @Bean
    public HeadersExchange headers_exchange() {
        return new HeadersExchange("headers_exchange");
    }

    @Bean
    Binding bindingExchangeTopicQueue2(@Qualifier("headers_queue") Queue queue, HeadersExchange headers_exchange) {
        ...
        //whereAny表示部分匹配
        return BindingBuilder.bind(queue).to(headers_exchange).whereAll(map).match();
    }
